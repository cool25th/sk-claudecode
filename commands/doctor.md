---
description: Diagnose and fix sk-claudecode installation issues
---
...
**Diagnosis**:
- If `~/.claude/agents/` exists with sk-claudecode-related files: WARN - legacy agents (now provided by plugin)
- If `~/.claude/commands/` exists with sk-claudecode-related files: WARN - legacy commands (now provided by plugin)
- If `~/.claude/skills/` exists with sk-claudecode-related files: WARN - legacy skills (now provided by plugin)

Look for files like:
- `architect.md`, `researcher.md`, `explore.md`, `executor.md`, etc. in agents/
- `ultrawork.md`, `deepsearch.md`, etc. in commands/
- Any sk-claudecode-related `.md` files in skills/
...
### Fix: Outdated Plugin
```bash
rm -rf ~/.claude/plugins/cache/sk-claudecode
...
```
WebFetch(url: "https://raw.githubusercontent.com/Yeachan-Heo/sk-claudecode/main/docs/CLAUDE.md", prompt: "Return the complete raw markdown content exactly as-is")
```
...
**Note**: Only remove if these contain sk-claudecode-related files. If user has custom agents/commands/skills, warn them and ask before removing.
