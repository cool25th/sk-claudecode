...
Create `.skc/prd.json` and `.skc/progress.txt` based on the task description.
...
After creating files, report summary and suggest running `/sk-claudecode:ralph-loop` to start.
