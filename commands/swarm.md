...
```
/sk-claudecode:swarm N:agent-type "task description"
```

### Aggressive Mode (20-50+ tasks)
```
/sk-claudecode:swarm aggressive:agent-type "large task description"
```
or
```
/sk-claudecode:swarm 30:executor "fix all TypeScript errors"
```
...
```bash
# Standard Mode
/sk-claudecode:swarm 5:executor "fix all TypeScript errors"
/sk-claudecode:swarm 3:build-fixer "fix build errors in src/"
/sk-claudecode:swarm 4:designer "implement responsive layouts for all components"
/sk-claudecode:swarm 2:architect "analyze and document all API endpoints"

# Aggressive Mode
/sk-claudecode:swarm 30:executor "fix all TypeScript errors"
/sk-claudecode:swarm aggressive:build-fixer "fix build errors across entire codebase"
```
...
```
/sk-claudecode:swarm 3:executor "fix linting errors in src/api/"
```
...
```
/sk-claudecode:swarm 30:executor "fix all TypeScript errors across codebase"
```
...
```
/sk-claudecode:swarm aggressive:executor "add unit tests for all untested functions"
```
...
```
/sk-claudecode:swarm 25:writer "add JSDoc comments to all exported functions"
```
...
### Security Audit
```
/sk-claudecode:swarm aggressive:security-reviewer "audit codebase for SQL injection vulnerabilities"
```
