...
**If NOT parallelizable:** Fall back to regular `/sk-claudecode:autopilot`
...
When all phases complete and Architect validates, run `/sk-claudecode:cancel` to cleanly exit ultrapilot and clean up state files.
