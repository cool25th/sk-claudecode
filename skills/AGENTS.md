...
Skills are reusable workflow templates that can be invoked via `/sk-claudecode:skill-name`. Each skill provides:
...
```bash
# Manual invocation
/sk-claudecode:skill-name

# With arguments
/sk-claudecode:skill-name arg1 arg2
...
- Test skill invocation with `/sk-claudecode:skill-name`
