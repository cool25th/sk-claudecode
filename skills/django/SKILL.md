---
name: django
description: Comprehensive Django development guidance spanning architecture patterns, testing, security, and workflow.
---
...
## Merged from `django-verification`
