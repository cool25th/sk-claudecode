...
```
/sk-claudecode:autopilot <your idea>
/sk-claudecode:ap "A CLI tool that tracks daily habits"
/sk-claudecode:autopilot Add dark mode to the app
```
...
If autopilot was cancelled or failed, just run `/sk-claudecode:autopilot` again to resume from where it stopped.

## Examples

**New Project:**
```
/sk-claudecode:autopilot A REST API for a bookstore inventory with CRUD operations
```

**Feature Addition:**
```
/sk-claudecode:autopilot Add user authentication with JWT tokens
```

**Enhancement:**
```
/sk-claudecode:ap Add dark mode support with system preference detection
```
