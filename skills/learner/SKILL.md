...
Use /sk-claudecode:learner ONLY after:
...
- **User-level**: ~/.claude/skills/skc-learned/ - Rare. Only for truly portable insights.
- **Project-level**: .skc/skills/ - Default. Version-controlled with repo.
