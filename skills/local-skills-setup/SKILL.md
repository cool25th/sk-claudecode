...
- `/sk-claudecode:local-skills-setup list` - Show detailed skill inventory
- `/sk-claudecode:local-skills-setup add` - Start skill creation (invoke learner)
- `/sk-claudecode:local-skills-setup scan` - Scan both skill directories
...
- `/sk-claudecode:learner` - Extract a skill from current conversation
- `/sk-claudecode:note` - Save quick notes (less formal than skills)
- `/sk-claudecode:deepinit` - Generate AGENTS.md codebase hierarchy
...
- Run `/sk-claudecode:local-skills-setup scan` periodically to review your skill library
