...
| Command | Action |
|---------|--------|
| `/sk-claudecode:writer-memory init <project-name>` | Initialize new project memory |
| `/sk-claudecode:writer-memory status` | Show memory overview (character count, scene count, etc) |
| `/sk-claudecode:writer-memory char add <name>` | Add new character |
| `/sk-claudecode:writer-memory char <name>` | View character details |
| `/sk-claudecode:writer-memory char update <name> <field> <value>` | Update character field |
| `/sk-claudecode:writer-memory char list` | List all characters |
| `/sk-claudecode:writer-memory rel add <char1> <char2> <type>` | Add relationship |
| `/sk-claudecode:writer-memory rel <char1> <char2>` | View relationship |
| `/sk-claudecode:writer-memory rel update <char1> <char2> <event>` | Add relationship event |
| `/sk-claudecode:writer-memory scene add <title>` | Add new scene |
| `/sk-claudecode:writer-memory scene <id>` | View scene details |
| `/sk-claudecode:writer-memory scene list` | List all scenes |
| `/sk-claudecode:writer-memory theme add <name>` | Add theme |
| `/sk-claudecode:writer-memory world set <field> <value>` | Set world attribute |
| `/sk-claudecode:writer-memory query <question>` | Query memory naturally (Korean supported) |
| `/sk-claudecode:writer-memory validate <character> <dialogue>` | Check if dialogue matches character tone |
| `/sk-claudecode:writer-memory synopsis` | Generate emotion-focused synopsis |
| `/sk-claudecode:writer-memory export` | Export full memory as readable markdown |
| `/sk-claudecode:writer-memory backup` | Create manual backup |
...
### With SKC Notepad System
Writer Memory integrates with `.skc/notepad.md`:
...
```
Task(subagent_type="sk-claudecode:architect",
     model="opus",
