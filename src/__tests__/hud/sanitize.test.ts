...
describe('sanitizeOutput', () => {
  ...
  it('should handle complex HUD output preserving colors', () => {
    const input = '\x1b[1m[SKC]\x1b[0m | \x1b[32m████░░░░░░\x1b[0m 40% | agents:3';
    expect(sanitizeOutput(input)).toBe('\x1b[1m[SKC]\x1b[0m | \x1b[32m####------\x1b[0m 40% | agents:3');
  });
  ...
  it('should handle real HUD multi-line output with colors and newlines preserved', () => {
    const input = `\x1b[1m[SKC]\x1b[0m | \x1b[2m5h:\x1b[0m\x1b[32m12%\x1b[0m | Ctx: \x1b[32m████░░░░░░\x1b[0m 40%
...
\x1b[2m└─\x1b[0m \x1b[33ms\x1b[0m:executor (1m) writing tests`;
  ...
  it('should handle single line output without modification', () => {
    const input = '[SKC] | 40% | agents:3';
    expect(sanitizeOutput(input)).toBe('[SKC] | 40% | agents:3');
  });
});
