...
describe('Skill Finder', () => {
  ...
  beforeEach(() => {
    ...
    mkdirSync(join(projectRoot, '.skc', 'skills'), { recursive: true });
  });
  ...
  it('should find project-level skills', () => {
    const skillPath = join(projectRoot, '.skc', 'skills', 'test-skill.md');
  ...
  it('should prioritize project skills over user skills', () => {
    ...
    const projectSkillPath = join(projectRoot, '.skc', 'skills', 'skill.md');
  ...
  it('should populate sourceDir for project skills', () => {
    ...
    expect(projectCandidate!.sourceDir).toBe(join(projectRoot, '.skc', 'skills'));
  });
  ...
  it('should respect depth limit for deep directories', () => {
    ...
    let deepDir = join(projectRoot, '.skc', 'skills');
    for (let i = 0; i < 15; i++) {
  ...
  it('should construct PROJECT_SKILLS_SUBDIR with path.join', () => {
    expect(PROJECT_SKILLS_SUBDIR).toBe(join('.skc', 'skills'));
  });
});
