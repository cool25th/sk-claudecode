...
describe('Ralph Progress Module', () => {
  ...
  describe('initProgress', () => {
    it('should create progress.txt in .skc directory', () => {
      expect(initProgress(testDir)).toBe(true);
      expect(existsSync(join(testDir, '.skc', PROGRESS_FILENAME))).toBe(true);
    });
  ...
  describe('readProgressRaw / readProgress', () => {
    ...
    it('should read progress from .skc directory', () => {
