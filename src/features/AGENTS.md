...
Core feature modules for sk-claudecode - model routing, state management, verification, and more.
...
**State location:** `.skc/state/boulder.json`
...
**Location:** `.skc/notepads/{plan-name}/`
