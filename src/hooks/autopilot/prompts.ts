...
\`\`\`
Task(
  subagent_type="sk-claudecode:critic",
  model="opus",
...
\`\`\`
Task(
  subagent_type="sk-claudecode:architect-low",
  model="haiku",
...
\`\`\`
Task(
  subagent_type="sk-claudecode:build-fixer",
  model="sonnet",
...
// Security Review
Task(
  subagent_type="sk-claudecode:security-reviewer",
  model="opus",
...
// Code Quality Review
Task(
  subagent_type="sk-claudecode:code-reviewer",
  model="opus",
