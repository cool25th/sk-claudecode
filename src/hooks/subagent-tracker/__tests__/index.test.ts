...
describe("subagent-tracker", () => {
        ...
        agents: [
          {
            ...
            agent_type: "sk-claudecode:executor",
  ...
  describe("getAgentDashboard", () => {
    ...
    it("should show tool count and last tool", () => {
      const state: SubagentTrackingState = {
        agents: [
          {
            agent_id: "test-123",
            agent_type: "sk-claudecode:architect",
            started_at: new Date().toISOString(),
            parent_mode: "none",
            status: "running",
            tool_usage: [
    ...
    it("should strip sk-claudecode: prefix from agent type", () => {
      const state: SubagentTrackingState = {
        agents: [
          {
            agent_id: "test-123",
            agent_type: "sk-claudecode:architect-high",
            started_at: new Date().toISOString(),
            parent_mode: "none",
            status: "running",
          },
      ...
      expect(dashboard).not.toContain("sk-claudecode:architect-high");
    });
  });
    ...
    it("should detect file conflicts between agents", () => {
      const state: SubagentTrackingState = {
        agents: [
          ...
          {
            agent_id: "agent-2",
            agent_type: "sk-claudecode:designer",
            started_at: new Date().toISOString(),
            parent_mode: "ultrawork",
            status: "running",
