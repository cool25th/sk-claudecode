...
describe('session-replay', () => {
  ...
  describe('event helpers', () => {
    it('recordAgentStart should record start event', () => {
      recordAgentStart(testDir, 'sess3', 'agent-123', 'sk-claudecode:executor', 'Fix the bug', 'ultrawork', 'sonnet');
    ...
    it('recordAgentStop should record stop event', () => {
      recordAgentStop(testDir, 'sess4', 'agent-456', 'sk-claudecode:architect', true, 5000);
