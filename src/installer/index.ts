  ...
  try {
    ...
    if (!projectScoped) try {
      ...
      const hudScriptLines = [
        ...
        '    console.log(`[SKC HUD] Plugin cache found but no versions installed. Run: /sk-claudecode:setup`);',
        '  } else {',
        '    // No plugin installation found at all',
        '    console.log("[SKC HUD] Plugin not installed. Run: /sk-claudecode:setup");',
        '  }',
        '}',
        '',
        'main();',
